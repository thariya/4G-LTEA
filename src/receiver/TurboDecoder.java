...
public class TurboDecoder extends edu.mit.streamjit.api.Pipeline<Byte, Float> {
	...
	public TurboDecoder() {
		super(new PolarEncoder(), new Divider(),
				// new BytePrinter(),
				new Splitjoin<Byte, Float>(new RoundrobinSplitter<Byte>(86), new RoundrobinJoiner<Float>(2), new L(),
						new L()),
				new Connector(),
				// new Printer(),
	...
	private static class Lprime1 extends edu.mit.streamjit.api.Filter<Byte, Float> {
	...
	private static class Lprime2 extends edu.mit.streamjit.api.Filter<Byte, Float> {
