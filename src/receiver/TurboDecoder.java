...
//				new Printer(),
	...
	private static class L extends
	edu.mit.streamjit.api.Pipeline<Byte, Float> {
		
		public L() {
			this.add(new Preprocess(),				
				  new Splitjoin<Data,Data>(
							new RoundrobinSplitter<Data>(),
							new RoundrobinJoiner<Data>(),
							new Dummy(),
							new AlphaTraversal(),
							new BetaTraversal()
					),
...
//			System.out.println();
	...
	private static class Preprocess extends
	edu.mit.streamjit.api.Filter<Byte, Data> {
...
//				System.out.println(parity[i]);					
	...
	private static class AlphaTraversal extends
	edu.mit.streamjit.api.Filter<Data, Data> {
...
//			System.out.println(d);
	...
	private static class BetaTraversal extends
	edu.mit.streamjit.api.Filter<Data, Data> {
...
//			System.out.println(d);
	...
	private static class Postprocess extends
	edu.mit.streamjit.api.Filter<Data, Float> {
...
//				System.out.println(temp);
	...
	private static class Predictor extends
	edu.mit.streamjit.api.Filter<Float, Byte> {
