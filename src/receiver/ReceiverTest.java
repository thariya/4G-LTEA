...
public class ReceiverTest {
	...
	public static final class ReceiverBenchmarkTest extends SuppliedBenchmark {
		public ReceiverBenchmarkTest(int j) {
			...
			super("ReceiverTest", ReceiverKernelTest.class, new Dataset("channel_out.out", (Input) Datasets.nCopies(j,
					Input.fromBinaryFile(Paths.get("channel_out.out"), Float.class, ByteOrder.BIG_ENDIAN))
			// ,
