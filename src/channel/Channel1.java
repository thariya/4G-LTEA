...
public class Channel1 extends edu.mit.streamjit.api.Filter<Float, Float> {
	static ComplexMatrix H;
	static ComplexMatrix H_out;
	{
		initH();
		// System.out.println(H.toText());
		// System.out.println(H_out.toText());
	}

	public Channel1(int length) {
	...
	private void save() {
		try {
			FileOutputStream fileOut1 = new FileOutputStream("H.ser");
			FileOutputStream fileOut2 = new FileOutputStream("Hout.ser");
	...
	private void retrieve() {
		try {
			FileInputStream fileOut1 = new FileInputStream("H.ser");
			FileInputStream fileOut2 = new FileInputStream("Hout.ser");
			ObjectInputStream out1 = new ObjectInputStream(fileOut1);
			H = (ComplexMatrix) out1.readObject();
			ObjectInputStream out2 = new ObjectInputStream(fileOut2);
			H_out = (ComplexMatrix) out2.readObject();
			out1.close();
			out2.close();
			fileOut1.close();
			fileOut2.close();
