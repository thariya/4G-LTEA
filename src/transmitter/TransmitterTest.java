...
//		stream.awaitDrained();
	...
	public static final class TransmitterBenchmarkTest extends SuppliedBenchmark {
		public TransmitterBenchmarkTest(int j) {
			super("Transmitter", TransmitterKernelTest.class, new Dataset("data.in",
					(Input)Datasets.nCopies(j, Input.fromBinaryFile(Paths.get("data.in"), Byte.class, ByteOrder.LITTLE_ENDIAN))
