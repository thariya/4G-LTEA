...
public class TurboEncoder extends edu.mit.streamjit.api.Pipeline<Byte, Byte> {
	...
	private static class Encoder extends edu.mit.streamjit.api.Filter<Byte, Byte> {
	...
	private static class Output1 extends edu.mit.streamjit.api.Filter<Byte, Byte> {
	...
	private static class Output2 extends edu.mit.streamjit.api.Filter<Byte, Byte> {
	...
	private static class Output3 extends edu.mit.streamjit.api.Filter<Byte, Byte> {
	...
	private static class Printer extends edu.mit.streamjit.api.Filter<Byte, Byte> {
